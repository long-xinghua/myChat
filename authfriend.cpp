    ...
    ui(new Ui::AuthFriend)
{
    ...
    connect(ui->moreLabel, &ClickOnceLabel::clicked, this, &AuthFriend::slotShowMoreLabel);  // 点击moreLabel显示更多现有标签
    initTipLbs();

    connect(ui->labelEdit, &CustomizedEdit::returnPressed, this, &AuthFriend::slotLabelEnter);  //链接输入标签回车事件
    connect(ui->labelEdit, &CustomizedEdit::textChanged, this, &AuthFriend::slotLabelTextChange);
    connect(ui->labelEdit, &CustomizedEdit::editingFinished, this, &AuthFriend::slotLabelEditFinished);
    connect(ui->tipLabel, &ClickOnceLabel::clicked, this, &AuthFriend::slotAddFirendLabelByClickTip);
    ...
    //连接确认和取消按钮的槽函数
    connect(ui->cancelBtn, &QPushButton::clicked, this, &AuthFriend::slotApplyCancel);
    connect(ui->confirmBtn, &QPushButton::clicked, this, &AuthFriend::slotApplySure);
...
void AuthFriend::setSearchInfo(std::shared_ptr<SearchInfo> si)
{
    _si = si;
...
void AuthFriend::setApplyInfo(std::shared_ptr<ApplyInfo> applyInfo)
{
...
void AuthFriend::addLabel(QString name)
{
    ...
    connect(tempLabel, &friendLabel::sig_close, this, &AuthFriend::slotRemoveFriendLabel); // 连接删除该标签时的操作
...
void AuthFriend::slotShowMoreLabel()
{
...
void AuthFriend::slotLabelEnter()
{
    ...
    lb->setObjectName("tipslb");
    lb->setText(text);
    connect(lb, &ClickedLabel::clicked, this, &AuthFriend::slotChangeFriendLabelByTip);    // 联动新好友标签列表和展示栏标签列表
...
void AuthFriend::slotChangeFriendLabelByTip(QString text, ClickLbState curState)
{
